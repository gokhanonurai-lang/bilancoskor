      ...
      <div className="bg-white rounded-3xl w-full max-w-3xl max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
          ...
          <section>
            ...
            <div className="rounded-2xl border border-gray-100 overflow-hidden">
              ...
              {[
                ...
                ['D','0–34','—','Finansman erişimi sınırlı olabilir','—',false],
              ].map(([b,s,l,t,k,a]) => (
          ...
          <section>
            ...
            {[
              {tur:'Taksitli İşletme Kredisi (12–24 ay)', desc:'Duran varlıklarınız 18.918.385 TL. Makine, ekipman veya yapısal yatırımlar için 12–24 ay vadeli taksitli kredi uygundur. Sabit taksitlerle nakit akışı planlaması kolaylaşır. Faiz ortamına bağlı olarak uzun vadeli finansman tercihleri farklı riskler barındırabilir.'},
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <KB baslik="Borç Ödeme Kapasitesi" puan={16} max={16} rasyolar={[
                {ad:'Faiz karşılama oranı',deger:'30.53x',ort:'3.20x',bant:'mukemmel',desc:'FAVÖKünüz faiz giderlerinizin 30.5 katı. Faiz yükümlülüklerinizi rahatlıkla karşılayabiliyorsunuz. Bu oran, finansal değerlendirme süreçlerinde olumlu bir gösterge olarak değerlendirilebilir.',iyilestir:['Faiz oranlarını yeniden müzakere edin — özellikle ticari kredi faizlerinde','Yüksek faizli kredileri KGF destekli veya KOSGEB kredisiyle refinanse edin']},
